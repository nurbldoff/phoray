...
m = 1
ldensity = 1200.e3
theta = degrees(asin(m*wavel1*ldensity/(2*sin(radians(3.5)))))
...
#paraboloid
a5p = d2_m5*sin(2*theta_m5)/(2*tan(theta_m5)) - d2_m5*cos(2*theta_m5)
A5p = 1/(2*d2_m5*sin(2*theta_m5)*tan(theta_m5))
C5p=-1/(2*a5p)
Cx5p=None
asph5p=-1
